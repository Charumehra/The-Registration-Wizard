  ...
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-6 animate-in fade-in zoom-in duration-500">
      <div className="relative">
        ...
        <div className="relative bg-emerald-100 p-4 rounded-full border-2 border-emerald-200">
          <CheckCircle className="w-16 h-16 text-emerald-600" strokeWidth={2.5} />
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-500 max-w-[280px] mx-auto text-sm leading-relaxed">
          Your account has been successfully summoned. Welcome to the inner circle!
        </p>
      </div>
      ...
      <div className="bg-gray-50 border border-gray-100 rounded-2xl p-4 w-full flex items-center justify-around">
        ...
        <div className="text-center">
          <p className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Access</p>
      ...
      <div className="w-full space-y-3 pt-4">
        ...
        <button
          onClick={onReset}
          className="text-gray-400 hover:text-gray-600 text-xs font-semibold underline underline-offset-4 hover:decoration-gray-400 transition-all"
        >
